...
// Carrusel holográfico functionality
let currentSlide = 0;
const totalSlides = 4;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🔥 MATRIX PROTOCOL ACTIVE 🔥');
...
class CyberpunkAudioSystem {
    ...
    playAmbient() {
        ...
        this.sounds.ambient.volume = this.volume * 0.3; // Más suave para música de fondo
...
// Función global para reproducir sonidos desde cualquier parte
